...
def ajax_test():
    print(web_api("{\"function_name\":\"connection_is_ok\", \"arguments\":null, "
                  "\"source_caller\":\"front-end-function1\"}",
                  True))
    print(web_api(
        "{\"function_name\":\"account_status\", \"arguments\":{\"user_email\":\"test.account@treasuryquants.com\"}, \"source_caller\":\"front-end-function2\"}",
        True))
    print(web_api(
        "{\"function_name\":\"account_create\", \"arguments\":{\"user_password\":\"test.account@treasuryquants.com\",\"user_email\":\"cholpine@outlook.com\",\"user_ip\":\"127.0.0.1\", \"callback_url\":\"treasuryquants.com/urlcallback/\"}, \"source_caller\":\"front-end-function3\"}",
        True))
    print(web_api(
